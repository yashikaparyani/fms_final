...
const CameraButton = ({ isDisabled, onClick, compact }) => (
  <button
    type="button"
    disabled={isDisabled}
    onClick={onClick}
    ...
    className={`inline-flex items-center gap-1.5 text-xs font-semibold ${
      compact ? "px-3" : "px-2.5"
    } py-1.5 rounded-md border transition-colors whitespace-nowrap ${
      isDisabled
        ? "text-gray-400 bg-gray-50 border-gray-200 cursor-not-allowed"
        : "text-gray-700 bg-white border-gray-200 hover:border-indigo-500 hover:text-indigo-600 cursor-pointer"
    }`}
  ...
  return (
    <div className="font-sans">
      ...
      <div className="hidden md:block border border-gray-100 rounded-xl overflow-hidden">
        {/* Header */}
        <div className="grid grid-cols-[2fr_110px_1.5fr_80px_235px_90px] bg-gray-50 border-b border-gray-200 px-4 py-2">
        ...
        {documentTypes.map((type, idx) => {
          ...
          return (
            <div
              key={type}
              className={`grid grid-cols-[2fr_110px_1.5fr_80px_235px_90px] px-4 py-2.5 items-center transition-colors hover:bg-slate-50 ${
      ...
      <CameraCapture
        ...
        onCapture={(file) => handleUpload(cameraType, file)}
      />
    </div>
  );
};
